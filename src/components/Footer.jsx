		...
		<div className="relative p-2 bg-blue-950 pt-[50px]">
			...
			<div className="grid grid-cols-2 md:grid-cols-3 gap-4 mx-10 md:mx-auto max-w-[1200px]">
				...
				<div className="flex p-5 gap-2 flex-col mx-auto items-center">
					...
					<a
						href="https://www.instagram.com/brasaberkeley/?hl=en"
						target="_blank"
						className="fill-gray-300 hover:fill-gray-500 cursor-pointer"
					>
						<svg
							className="h-8 w-8"
							xmlns="http://www.w3.org/2000/svg"
					...
					<a
						href="https://www.linkedin.com/in/brasa-berkeley/"
						target="_blank"
						className="fill-gray-300 hover:fill-gray-500 cursor-pointer"
					>
						<svg
