			...
			<div className="bg-white p-8 flex flex-col md:flex-row md:space-x-12">
				...
				<div className="md:w-1/2 mb-8 md:mb-0">
					...
					<p className="text-gray-700">
						...
						Reprehenderit explicabo, repellendus deserunt itaque
						commodi iste dignissimos. Rem itaque voluptate ipsam.
						Ipsam atque aliquam quam maxime minima corrupti suscipit
						obcaecati ipsa!
					</p>
				</div>
				{/* Column 2 */}
